...
{
    public class SubmitInventoryFeed
    {
        ...
        public static string SubmitAmazonInventoryFeed(string accountName, string filepath, string merchantId, string marketplaceId, string accessKeyId, string secretAccessKey)
        {
            ...
            catch (MarketplaceWebServiceException ex)
            {
                ...
                exceptionUtility.CatchMethod(ex, "SubmitInventoryFeed->SubmitAmazonInventoryFeed Error:", ex.Message.ToString() + " Response Status Code: " + ex.StatusCode + " Error Code: " + ex.ErrorCode + " Error Type: " + ex.ErrorType + " Request ID: " + ex.RequestId, senderEmail, messageFromPassword, messageToEmail, smtpClient, smtpPortNum);
